...
/** State Bank of India (SBI Card) — generic discovery + JSON-LD product page adapter (no dedicated deep crawler yet). */
export const sbiAdapter: BankCrawlerAdapter = createGenericBankAdapter(bankSource);
