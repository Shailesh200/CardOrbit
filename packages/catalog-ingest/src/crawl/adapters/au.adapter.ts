...
/** AU Small Finance Bank — issuer adapter with bank-tuned discovery + fee/MITC extraction. */
export const auAdapter: BankCrawlerAdapter = createIssuerBankAdapter(bankSource, {
