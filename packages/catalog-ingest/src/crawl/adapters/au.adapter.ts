...
/** AU Small Finance Bank — generic discovery + JSON-LD product page adapter (no dedicated deep crawler yet). */
export const auAdapter: BankCrawlerAdapter = createGenericBankAdapter(bankSource);
