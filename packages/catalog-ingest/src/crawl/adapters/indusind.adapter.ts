...
/** IndusInd Bank — issuer adapter with bank-tuned discovery + fee/MITC extraction. */
export const indusindAdapter: BankCrawlerAdapter = createIssuerBankAdapter(bankSource, {
