...
/** Bank of Baroda (BOBCARD) — generic discovery + JSON-LD product page adapter (no dedicated deep crawler yet). */
export const bobAdapter: BankCrawlerAdapter = createGenericBankAdapter(bankSource);
