...
const source = INDIA_AGGREGATOR_SOURCES.find((row) => row.slug === 'cardinsider');
if (!source) throw new Error('Missing cardinsider aggregator source');

export const cardinsiderAdapter: CatalogCrawlerAdapter = {
