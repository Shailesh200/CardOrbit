...
/** Axis Bank — generic discovery + JSON-LD product page adapter (no dedicated deep crawler yet). */
export const axisAdapter: BankCrawlerAdapter = createGenericBankAdapter(bankSource);
