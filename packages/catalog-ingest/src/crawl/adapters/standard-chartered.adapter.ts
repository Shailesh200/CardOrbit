...
/** Standard Chartered (India) — issuer adapter with bank-tuned discovery + fee/MITC extraction. */
export const standardCharteredAdapter: BankCrawlerAdapter = createIssuerBankAdapter(bankSource, {
