...
check 'favicon-32.png exists' "[ -f '$WEB/public/favicon-32.png' ]"
check 'apple-touch-icon.png exists' "[ -f '$WEB/public/apple-touch-icon.png' ]"
check 'keyword-rich home title' "grep -q 'Which Credit Card' '$INDEX'"
